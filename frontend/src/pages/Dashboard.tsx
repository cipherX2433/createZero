...
export default function Dashboard() {
    ...
    const handleQuickCreate = (prompt: string) => {
        ...
        setError('');
        // Navigate to Created page with prompt data for auto-generation
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingBottom: 200 }}>
                    <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, textAlign: 'center' }}>
                        ...
                        <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 36, letterSpacing: '-1px', lineHeight: 1.2 }}>
                            What do you want to
                            <span style={{ color: '#14b8a6' }}> create</span>?
                        </div>
                        <div style={{ fontSize: 16, color: '#555', maxWidth: 440, lineHeight: 1.7 }}>
                            Describe your idea below and we'll generate a scroll-stopping social media post with AI-powered visuals.
                        </div>

                        {/* Quick Suggestions */}
                        <div style={{ display: 'flex', gap: 10, marginTop: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
                            {['5 tips for better sleep', 'SaaS growth hacks 2025', 'Morning routine for CEOs', 'Why habits > motivation'].map(s => (
                                <button
                                    key={s}
