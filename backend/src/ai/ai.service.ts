...
export class AIService {
    ...
    /**
     * Generate a short video clip from a user prompt via Google Gemini Veo 3.
     */
    async generateVideo(
        prompt: string,
        resolution: string = "720P",
        ...
        console.log(`[AI] Generating video via Gemini Veo 3: ${prompt.substring(0, 80)}`);
        ...
        console.log("[AI] Waiting for Gemini Veo 3 video generation...");
        ...
        if (!generatedVideos || generatedVideos.length === 0) {
            throw new Error("No video was generated by Gemini Veo 3");
        }
        ...
        console.log("[AI] Gemini Veo 3 video generated successfully");
